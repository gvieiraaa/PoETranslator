...
;CARREGAR EN
ArrayCountEN = 0
Loop, Read, C:\Users\Gustavo\Documents\POE\scripts\tradução\EN.txt
{
    ArrayENCount += 1
...
ArrayCountPT = 0
;CARREGAR PT
Loop, Read, C:\Users\Gustavo\Documents\POE\scripts\tradução\PT.txt
{
    ArrayPTCount += 1
...
;TESTE: MsgBox, %ArrayEN55% %ArrayPT55% 
